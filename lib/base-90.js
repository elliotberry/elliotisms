// JSON values -> URL-safe string (and back).
//
// RFC 3986 unreserved alphabet is 66 chars (A-Z a-z 0-9 -._~). That is the
// densest base that can sit in a path, query, or fragment with no encoding.
// A 90-char alphabet cannot be URL-safe.
//
...
const FULL_BYTES = 8
const FULL_CHARS = 11 // 66^11 >= 2^64 > 66^10

// Remainder r bytes (1..7) -> fewest digits k with 66^k >= 256^r
